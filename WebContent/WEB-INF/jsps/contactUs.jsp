...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h1>Got Questions?</h1>
        <p class="lead">We have answers! Just send us an email to: info@bestflights.com</p>
        <p><a class="btn btn-lg btn-success" href="mailto:info@bestflights.com" role="button">Compose Email</a></p>
      </div>
